...
## [1.1.1](https://github.com/milbar/bulk-optimize-images-locally/compare/v1.1.0...v1.1.1) (2026-07-17)


### Bug Fixes

* scan current directory instead of script install path ([fe98f9a](https://github.com/milbar/bulk-optimize-images-locally/commit/fe98f9a80b93949483dc9b768a6d3147d30a0515))

## [1.1.2](https://github.com/milbar/bulk-optimize-images-locally/compare/v1.1.1...v1.1.2) (2026-07-17)

### Bug Fixes

* scan current directory instead of script install path

## [1.1.1](https://github.com/milbar/bulk-optimize-images-locally/compare/v1.1.0...v1.1.1) (2026-07-17)

### Bug Fixes

* split release (GitHub) from publish (npm) workflows
* trigger release and publish on PR merge
* update workflows to Node 24

## [1.1.0](https://github.com/milbar/bulk-optimize-images-locally/compare/v1.0.0...v1.1.0) (2026-07-17)


### Features

* add manual npm publish workflow ([30c29e2](https://github.com/milbar/bulk-optimize-images-locally/commit/30c29e202d94d344cfa7bc3ef69af3447d37c9c0))
